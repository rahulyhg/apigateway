...
use Zyh\ApiGateway\Exception\InternalHttpException;
...
class Dispatcher
{
     ...
     * @param array $files
     *
     * @return \Zyh\ApiGateway\Dispatcher
     */
     ...
     * @param string|array $parameters
     *
     * @return \Zyh\ApiGateway\Http\InternalRequest
     */
     ...
     * 尝试调度一个内部请求
     *
     * @param \Zyh\ApiGateway\Http\InternalRequest $request
     *
