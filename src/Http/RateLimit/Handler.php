...
namespace Zyh\ApiGateway\Http\RateLimit;

use Zyh\ApiGateway\Http\Request;
use Illuminate\Cache\CacheManager;
use Illuminate\Support\Collection;
use Illuminate\Container\Container;
use Zyh\ApiGateway\Http\RateLimit\Throttle\Route;
use Zyh\ApiGateway\Contract\Http\RateLimit\Throttle;
use Zyh\ApiGateway\Contract\Http\RateLimit\HasRateLimiter;
...
class Handler
{
     ...
     *
     * @var \Zyh\ApiGateway\Contract\Http\RateLimit\Throttle
     */
    protected $throttle;
    ...
    {
        return sprintf('zhuyanhai.apigateway.%s.%s.%s', $this->keyPrefix, $key, $this->getRateLimiter());
    }
     ...
     *
     * @param string|\Zyh\ApiGateway\Contract\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
     ...
     *
     * @return \Zyh\ApiGateway\Contract\Http\RateLimit\Throttle
     */
     ...
     *
     * @param callable|\Zyh\ApiGateway\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
