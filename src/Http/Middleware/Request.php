...
use Zyh\ApiGateway\Event\RequestWasMatched;
use Zyh\ApiGateway\Http\Request as HttpRequest;
use Illuminate\Contracts\Container\Container;
use Zyh\ApiGateway\Contract\Debug\ExceptionHandler;
use Illuminate\Events\Dispatcher as EventDispatcher;
use Zyh\ApiGateway\Contract\Http\Request as RequestContract;
...
class Request
{
     ...
     *
     * @var \Zyh\ApiGateway\Contract\Debug\ExceptionHandler
     */
    protected $exception;
     ...
     *
     * @var \Zyh\ApiGateway\Http\Validator
     */
    protected $validator;
     ...
     * @param \Zyh\ApiGateway\Contract\Debug\ExceptionHandler   $exception
     * @param \Zyh\ApiGateway\Routing\Router                    $router
     * @param \Zyh\ApiGateway\Http\RequestValidator             $validator
